...
.a{background:var(--card-bg);border-radius:16px;overflow:hidden;box-shadow:0 2px 8px var(--shadow);transition:all .3s;border:1px solid var(--border);position:relative;break-inside:avoid;margin-bottom:18px;display:inline-block;width:100%}
...
.ae{font-size:14px;color:var(--text2);line-height:1.7;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical}
...
@media(max-width:600px){.mod-overlay{padding:0;align-items:stretch}.mod-overlay .mod-box{max-height:100vh;height:100vh;border-radius:0;max-width:100%}.mod-head{padding:10px 14px;min-height:44px;position:sticky;top:0;background:var(--card-bg);border-bottom:1px solid var(--border);z-index:10}.mod-head .mh-close{width:32px;height:32px;font-size:14px;background:rgba(255,255,255,0.08);border-radius:50%}.mod-title{padding:14px 16px 0;font-size:20px;line-height:1.4}.mod-body{padding:14px 16px;font-size:15px;line-height:1.85;flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch}.mod-footer{gap:6px;padding:10px 14px;border-top:1px solid var(--border);flex-direction:row;flex-wrap:wrap;align-items:center;flex-shrink:0;background:var(--card-bg);position:sticky;bottom:0;z-index:10}.mod-footer .mod-btn{padding:6px 10px;font-size:10px;border-radius:8px;flex-shrink:0}.mh-title{font-size:26px}.mh-meta{font-size:10px;gap:8px}.sub-t{padding:7px 14px;font-size:11px}.gr{column-count:1}.ai{aspect-ratio:16/10}.at{font-size:16px}.ae{font-size:13px;-webkit-line-clamp:2}.ftr-inner{grid-template-columns:1fr}.ftr-img{height:160px}.ftr-title{font-size:18px}.ftr-summary{font-size:12px}}
@media(max-width:768px){.content-wrap{display:block;padding:12px 14px;gap:0}.sidebar{display:none!important}.main-content{width:100%}.masthead{padding:16px 0 12px}.mh-title{font-size:32px;letter-spacing:1px}.mh-meta{gap:10px;font-size:11px;margin-top:8px}.flag-bar{height:3px}.top-bar{padding:6px 0}.ti{padding:0 14px}.tb-r{gap:10px}.clock{font-size:12px}.dt-btn{padding:5px 10px;font-size:11px}.ticker{padding:6px 0}.ticker-inner{padding:0 14px}.ticker-label{font-size:11px;padding:3px 10px}.ticker-text{font-size:12px}.sub-ts{padding:0 14px;gap:4px;margin-top:8px}.sub-t{padding:8px 16px;font-size:12px;border-radius:16px}.ctrls{padding:0 14px;margin-top:10px}.rf-btn{padding:10px 18px;font-size:13px;border-radius:10px}.gr{column-count:2;column-gap:10px}.a{border-radius:12px;margin-bottom:10px}.ai{aspect-ratio:16/9}.ai img{transition:none}.a:hover .ai img{transform:none}.ab{padding:10px 12px 14px}.am{margin-bottom:6px}.as{font-size:10px;padding:3px 8px}.ad{font-size:10px}.at{font-size:15px;margin-bottom:6px;line-height:1.3}.ae{font-size:12px;line-height:1.6;-webkit-line-clamp:2}.sb-btn{width:26px;height:26px;font-size:10px;top:6px;left:6px}.vi{width:30px;height:30px;font-size:12px;top:6px;right:6px}.ftr-art{margin:10px 0;border-radius:12px}.ftr-inner{grid-template-columns:1fr;min-height:auto}.ftr-img{height:180px}.ftr-body{padding:16px}.ftr-title{font-size:20px;line-height:1.3}.ftr-summary{font-size:13px;-webkit-line-clamp:2}.ftr-meta{font-size:11px;gap:10px}.ftr-sec{padding:16px 14px;margin-top:20px}html{font-size:15px}}
@media(max-width:480px){.mh-title{font-size:22px}.mh-meta{flex-wrap:wrap;justify-content:center}.gr{column-count:1}.at{font-size:15px}.ae{font-size:12px;-webkit-line-clamp:2}.sub-t{padding:6px 12px;font-size:10px}.ftr-title{font-size:16px}.mod-title{font-size:18px}.mod-body{font-size:14px;line-height:1.8}}"""
